#!/usr/bin/env bash
# Generate a truly standalone installer with all files base64 encoded

set -euo pipefail

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
OUTPUT_FILE="$SCRIPT_DIR/standalone-installer-complete.sh"

echo "🔧 Generating standalone installer with embedded files..."
